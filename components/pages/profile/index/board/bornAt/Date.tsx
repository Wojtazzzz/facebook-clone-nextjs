...
export const Date = ({ date }: DateProps) => {
    return (
        <div className="w-full flex flex-col items-center gap-3 text-dark-100 my-3 md:my-6">
            <div className="w-[30px] h-[30px] md:w-[40px] md:h-[40px] flex justify-center items-center bg-primary rounded-full shadow-[0_0_0_4px_rgb(58,59,60)]">
                <Image data-testid="born-img" src={BornImg} alt="" className="w-full h-full p-[10px]" />
            </div>
