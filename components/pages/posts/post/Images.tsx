	...
	return (
		<>
			<div className="w-full flex gap-1 mt-3" onClick={handleToggleGallery}>
				{images.length === 1 ? (
					<div className="w-full min-h-[300px] relative transition hover:brightness-110 cursor-pointer mt-3">
						<Image layout="fill" src={images[0]} alt="Image" objectFit="cover" />
					</div>
				) : (
					<>
						...
						<div className="w-1/2 min-h-[300px] relative transition hover:brightness-110 cursor-pointer">
							<Image layout="fill" src={images[1]} alt="Image" objectFit="cover" />
