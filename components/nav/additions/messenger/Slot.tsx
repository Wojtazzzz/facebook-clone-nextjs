...
export const Slot = ({ id, first_name, name, profile_image, background_image, message }: SlotProps) => {
	const dispatch = useAppDispatch();

	const handleOpenChat = () => {
		dispatch(toggleActiveMessenger());
		dispatch(toggleActiveChat({ id, first_name, name, profile_image, background_image }));
	};
